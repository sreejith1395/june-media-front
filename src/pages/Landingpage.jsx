    ...
    <div>
        ...
        <Row className='align-items-center'>
            ...
            <Col lg={6}>
                ...
                <p style={{textAlign:'justify'}}>where user can use their favourite videos user can upload 
                    any youtube videos by copy
                    and paste their url . videooo.com will allow to add and remove their uploaded videos 
